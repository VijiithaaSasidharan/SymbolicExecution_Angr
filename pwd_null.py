...
def is_successful(state):
    ...
    return 'Good'.encode() in stdout_output and 'Fail'.encode() in stdout_output  # :boolean


# path_to_binary = "pwd/pwd"  # :string/Users/bmk/Downloads/angr_ctf-master/650/ece650-a2
path_to_binary = "./pwd_null"  # :string
...
simulation.explore(find=is_successful, n=50)  # ,avoid=should_abort)
